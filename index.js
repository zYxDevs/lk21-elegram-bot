...
const bot = new Telegraf('1763331684:AAFraaJezals3LMWmGtHLp9KKduxBUWxgB8')
...
bot.command('start', (ctx) => {
  return ctx.reply('<b>Halo</b><i>'+ctx.from.first_name+'</i> Untuk menu klik tombol menu ya!', {
    parse_mode: 'HTML',
    ...Markup.inlineKeyboard([
      Markup.button.url('Channel Bot', 't.me/nekozu'),
